...
export interface HoldrArtistsERC1155Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface HoldrArtistsERC1155 extends BaseContract {
  connect(runner?: ContractRunner | null): HoldrArtistsERC1155;
  waitForDeployment(): Promise<this>;

  interface: HoldrArtistsERC1155Interface;
